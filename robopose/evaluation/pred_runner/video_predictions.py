...
from robopose.datasets.samplers import ListSampler
...
class VideoPredictionRunner:
    def __init__(self, scene_ds, cache_data=False, n_workers=4):
        ...
        dataloader = DataLoader(scene_ds, batch_size=1, num_workers=n_workers,
                                sampler=self.sampler, collate_fn=self.collate_fn)
